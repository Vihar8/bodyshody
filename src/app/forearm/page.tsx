...
const forearmExercises = [
  {
    ...
    steps: [
      "Sit on a bench with your forearms on your thighs and your wrists hanging over the edge.",
      "Hold a barbell or dumbbell and curl your wrists upwards, then lower slowly.",
    ],
  },
  {
    ...
    steps: [
      "Sit on a bench with your forearms on your thighs and your wrists hanging over the edge.",
      "Hold a barbell or dumbbell with palms facing down and curl your wrists upwards.",
    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="py-12 px-6">
        <div className="max-w-4xl mx-auto space-y-10">
          {forearmExercises.map((exercise, index) => (
            <div
            key={index}
